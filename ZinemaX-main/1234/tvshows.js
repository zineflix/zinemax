...
const SERIES_ENDPOINTS = [
    ...
    { url: 'https://vidsrc.net/embed/movie', name: 'Server 2' },
    { url: 'https://vidsrc.cc/v2/embed/movie/', name: 'Server 3' },
    { url: 'https://vidlink.pro/movie/', name: 'Server 4' },
    { url: 'https://api.hexa.watch/movie/', name: 'Server 5' },
    { url: 'https://111movies.com/movie/', name: 'Server 6' },
    { url: 'https://rivestream.live/embed?type=movie&id=', name: 'Server 7' },
    { url: 'https://vidsrc.dev/embed/movie/', name: 'Server 8' },
    { url: 'https://vidsrc.io/embed/movie/', name: 'Server 9' },
    { url: 'https://moviesapi.club/movie/', name: 'Server 10' }
];
...
fetchTVShows('fantasy', 'fantasyTVShows');
